...
export const Navbar = ()=>{
    ...
    return(
        <nav className="fixed z-50 h-14 w-full border-b shadow-sm bg-gradient-to-r from-black to-slate-800 flex items-center justify-between top-0">
           
           <div className="md:max-w-screen-xl max-md:px-4 mx-auto flex items-center w-full justify-between">
           <Logo />
           <ul className="flex gap-x-10 text-white max-md:hidden cursor-pointer">
            <li className={`hover:text-primary hover:font-bold transition-all ${path=="/dashboard" && 'text-blue-600 font-bold'}`}>Dashboard</li>
